...
public class PaymentProcessorImpl : IPaymentProcessor
{
	private readonly string PROCESSOR_API_URL = Environment.GetEnvironmentVariable("PAYMENT_PROCESSOR_URL") ?? throw new ArgumentException("processor api url env not defined");
